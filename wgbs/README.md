...
__Step 1__. Index your reference genome assembly.
...
__Step 2__. Map reads and generate an allc file with output from a binomial test.
...
__Optional__. Run DMRfind. DMRfind is ideal for finding differences between treatments and control, tissues, time points, etc., and can handle ≥2 allc files. Caution: ensure allc file names match sample identifiers and chromosomes in allc file are strictly numerical starting at 1.
